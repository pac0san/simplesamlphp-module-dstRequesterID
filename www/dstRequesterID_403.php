...
$state = \SimpleSAML\Auth\State::loadState($_REQUEST['StateId'], 'dstRequesterID:Authorize');

$globalConfig = \SimpleSAML\Configuration::getInstance();
$t = new \SimpleSAML\XHTML\Template($globalConfig, 'dstRequesterID:dstRequesterID_403.php');
